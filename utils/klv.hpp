...
namespace Utils {
  static std::string generate_klv(const int protocol, const std::string& version, const std::string& rid) {
    ...
    static std::array constant_values = {
        Hash::sha256(Utils::Hash::md5(Hash::sha256(std::to_string(protocol)))),
        Hash::sha256(Utils::Hash::sha256(version)),
        Hash::sha256(Utils::Hash::sha256(std::to_string(protocol)) + salts[3])
    };
